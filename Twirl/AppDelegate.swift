...
//  Twirl
//
//  Created by Aedan Joyce on 8/16/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
            ...
            let dashboard = HomeView(collectionViewLayout: layout)
            ...
            let action1 = UNNotificationAction(identifier: "action1", title: "Mark as complete", options: [])
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Twirl")
